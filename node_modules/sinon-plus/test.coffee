global.getLogger = () ->
    return {error: ->}
sp = require('sinon-plus')
nodemailer = require('nodemailer')
testCase = require('nodeunit').testCase
SmtpTransport = require('../../src/server/notification/transport/smtp').SmtpTransport
...
module.exports =
    TestSmtpTransport: testCase
        ...
        testNotificateUser: (test) ->
            ...
            transportMock = sp.mock transport
            ...
            nodemailerMock = sp.mock nodemailer
            nodemailerMock
                .expects('send_mail')
                .withArgs(mail_data)
                .once()
